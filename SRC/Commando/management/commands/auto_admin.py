...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any):
        ...
        if superusers.exists() and not force:
            ...
            return
        admin_username = decouple.config("DJANGO_ADMIN_USERNAME", default="admin")
        admin_password = decouple.config("DJANGO_ADMIN_PASSWORD", default=None)
        admin_email = decouple.config("DJANGO_ADMIN_EMAIL", default="notset@notset.com")
